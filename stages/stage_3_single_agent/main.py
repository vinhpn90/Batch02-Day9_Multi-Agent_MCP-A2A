...
QUESTION = (
    "A supplier breached a contract with a tech startup and caused lost profits. "
    "What remedies, penalties, and relevant case law should the startup consider?"
)
...
SYSTEM_PROMPT = (
    ...
    "these tools to build a comprehensive analysis. For contract breach questions, search "
    "the legal database and case law before answering. Keep your final answer under 500 words."
)
